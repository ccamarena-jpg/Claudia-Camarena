...
export const CAMPAIGN_DETAILS: Record<string, { material: string, action: string }> = {
  ...
  'TABLE TENT LUCKY ECLIPSE': { material: 'Portafiche de mesa', action: 'Colocar en la zona de pago (counter) sin obstruir otros medios de pago.' },
